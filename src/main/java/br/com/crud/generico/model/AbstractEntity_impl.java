...
public abstract class AbstractEntity_impl implements AbstractEntity{
	...
	public AbstractEntity_impl(String oid) {
		super();
		this.oid = oid;
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof AbstractEntity_impl) {
			AbstractEntity_impl ae = (AbstractEntity_impl) obj;
	...
	public boolean canEqual(Object obj) {
		return obj instanceof AbstractEntity_impl;
	}
